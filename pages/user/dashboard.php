...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($errors)) {
    ...
    $targetDir = "/var/www/html/uploads/tblreports/";
        ...
        <?php if (empty($approvedReports)) : ?>
          <div class="d-flex align-items-center justify-content-center">
            <div class="text-center">
              <img src="/var/www/html/assets/img/illustrations/empty-box.png" class="avatar avatar-xl mt-4" alt="">
                      ...
                      <?php if ($approvedReport['step1_approved'] == 1) : ?>
                        <?php if (!empty($approvedReport['report_data_step1'])) : ?>
                          ...
                          <?php if ($approvedReport['step2_approved'] == 0) : ?>
                            ...
                            <?php else : ?>
                              <button type="button" class="btn btn-secondary w-100" data-bs-toggle="modal" data-bs-target="#requeststep3" disabled>Request Step 2 (Pending)</button>
                            <?php endif; ?>
                          <?php else : ?>
                            <?php if ($approvedReport['step3_approved'] == 0) : ?>
                              ...
                              <?php else : ?>
                                <button type="button" class="btn btn-secondary w-100" data-bs-toggle="modal" data-bs-target="#requeststep3" disabled>Request Step 3 (Pending)</button>
                              <?php endif; ?>
                            <?php else : ?>
