    ...
    <div class="col-12">
        <div class="card mb-3">
            <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
              ...
              ?>
                        <img id="coverImage" src="<?php echo htmlentities($coverImageSrc); ?>" alt="Banner image"
                            class="rounded-top" style="height: 310px ; width: 100%; object-fit: cover;">
                    </label>
                </div>
            </div>
            <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
...
<div class="row">
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <ul class="list-unstyled mb-4 mt-3">
                    ...
                    <li class="d-flex align-items-center mb-3"><i class="bx bx-check"></i><span class="fw-medium mx-2"
                            data-i18n="Status">Status:</span> <span data-i18n="Active">Active</span></li>
                    <li class="d-flex align-items-center mb-3"><i class="bx bx-star"></i><span class="fw-medium mx-2"
                            data-i18n="Role">Role:</span>
                        <span><?php echo htmlentities($userData['RoleName']); ?></span>
                    </li>
                    <li class="d-flex align-items-center mb-3"><i class="bx bx-flag"></i><span class="fw-medium mx-2"
                            data-i18n="Address">Address:</span>
                        <span><?php echo htmlentities($userData['Address']); ?></span>
                    </li>
                    <li class="d-flex align-items-center mb-3"><i class="bx bx-buildings"></i><span
                            class="fw-medium mx-2" data-i18n="Department">Department:</span>
                    ...
                    <li class="d-flex align-items-center mb-3"><i class="bx bx-building"></i><span
                            class="fw-medium mx-2" data-i18n="Office">Office:</span>
                ...
                <ul class="list-unstyled mb-4 mt-3">
                    <li class="d-flex align-items-center mb-3"><i class="bx bx-phone"></i><span class="fw-medium mx-2"
                ...
                <ul class="list-unstyled mt-3 mb-0">
                    <li class="d-flex align-items-center mb-3"><i class="bx bx-user-circle  me-2"></i>
                        <div class="d-flex flex-wrap">
                            ...
                            <span
                                class="fw-medium me-2 mef2"><?php echo htmlentities($userData['HeadOfDepartment']); ?></span>
                        </div>
                    </li>
                    <li class="d-flex align-items-center mb-3"><i class="bx bx-user-circle  me-2"></i>
                        <div class="d-flex flex-wrap">
                            ...
                            <span
                                class="fw-medium me-2 mef2"><?php echo htmlentities($userData['DepHeadOfDepartment']); ?></span>
                        </div>
                    </li>
                    <li class="d-flex align-items-center mb-3"><i class="bx bx-user-circle  me-2"></i>
                        <div class="d-flex flex-wrap">
                            ...
                            <span
                                class="fw-medium me-2 mef2"><?php echo htmlentities($userData['HeadOfOffice']); ?></span>
                        </div>
                    </li>
                    <li class="d-flex align-items-center"><i class="bx bx-user-circle  me-2"></i>
                        <div class="d-flex flex-wrap">
                            <span class="fw-medium mx-2 " data-i18n="Deputy Head Of Office">Deputy Head Of
                                Office:</span>
                            <span
                                class="fw-medium me-2 mef2"><?php echo htmlentities($userData['DepHeadOffice']); ?></span>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form id="formValidationExamples" onsubmit="submitForm()"
                    ...
                    <div class="alert alert-warning" role="alert">
                        <h6 class="alert-heading mb-1" data-i18n="requirements_heading">Ensure that
                            these requirements are met</h6>
                        <span data-i18n="requirements">Minimum 8 characters long, uppercase &amp;
                            symbol</span>
                    </div>
                    <div class="row">
                        <div class="col-md-6 fv-plugins-icon-container">
                            <div class="form-password-toggle">
                                <label class="form-label" for="formValidationPass"
                                    data-i18n="password_label">Password</label>
                        ...
                        <div class="col-md-6 fv-plugins-icon-container">
                            <div class="form-password-toggle">
                                <label class="form-label" for="formValidationConfirmPass"
                                    data-i18n="onfirm_password_label">Confirm Password</label>
                                <div class="input-group input-group-merge has-validation">
                ...
                <div class="row">
                    <div class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!-- Disconnect Button -->
                            <button type="button" class="btn btn-label-danger d-flex align-items-center me-3"
                                data-bs-toggle="modal" data-bs-target="#disconnectModal">
                            ...
                            <div class="modal fade" id="disconnectModal" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form id="formValidationExamples" class="mb-3" onsubmit="submitForm()"
                                            method="post">
        ...
        <div class="modal-content">
            ...
            <form id="formValidationExamples" onsubmit="submitForm()" class="row g-3" method="POST">
                ...
                <div class="modal-body p-5">
                    ...
                    <div class="alert alert-warning d-flex flex-column align-items-center justify-content-center mt-3"
                        role="alert">
                        <h1 class="alert-heading text-center fw-bolder mb-0 mx-3">
                            <?= $g->getCode($secret); ?>
                        </h1>
                        <p class="mb-0">ប្រសិនបើមានបញ្ហាទៅលើ QR CODE អ្នកអាចវាយបញ្ចូលលេខកូដ៦ខ្ទង់នេះបាន</p>
                    </div>
                    <div class="col-md-12">
                        <input type="text" id="modalEnableOTPPhone" name="modalEnableOTPPhone" required
                            class="form-control phone-number-otp-mask"
                            placeholder="បញ្ចូលលេខកូដពី Google Authenticator">
        ...
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                <div class="col-12 text-end">
                    <button type="button" class="btn btn-label-secondary me-sm-3 me-2 px-3 px-sm-4"
                        data-bs-toggle="modal" data-bs-target="#twoFactorAuth"><i
                            class="bx bx-left-arrow-alt bx-xs me-1 scaleX-n1-rtl"></i><span
                            class="align-middle">Back</span></button>
                    <button type="button" class="btn btn-primary px-3 px-sm-4" data-bs-dismiss="modal"
                        aria-label="Close"><span class="align-middle">Continue</span><i
                            class="bx bx-right-arrow-alt bx-xs ms-1 scaleX-n1-rtl"></i></button>
                </div>
            </div>
        </div>
    </div>
