                    ...
                    <div class="modal-body">
                        ...
                        <form id="formAuthentication" class="mb-3" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="regulatorname" name="regulatorname"
                                    placeholder="ឈ្មោះនិយ័តករ" autofocus required />
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="shortname" name="shortname"
                                    placeholder="ឈ្មោះនិយ័តករ" required />
                            </div>
    ...
    <div class="card mt-3">
        <div class="table-responsive text-nowrap">
            ...
            <tr>
                ...
                <td>
                    <span class="fw-medium"><?php echo htmlentities($result->create_at) ?></span>
                </td>
