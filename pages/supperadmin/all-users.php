        ...
        <tbody class='table-border-bottom-0'>
          <?php foreach ($results as $result) { ?>
            <tr>
                  ...
                  <?php if (!empty($result->Profile)) : ?>
                    <div class="avatar-wrapper">
                      <div class="avatar avatar-sm me-3">
                        <img src="<?php echo htmlentities($result->Profile); ?>" alt="Profile Picture" class="rounded-circle" style="object-fit: cover;" />
                      </div>
                    </div>
                  <?php else : ?>
                    <div class="avatar-wrapper">
              ...
              <td>
                <span class="fw-medium head-of-department"><?php echo $result->Position ?></span>
              </td>
              <td><?php echo htmlentities($result->CreationDate) ?></td>
              <td><?php echo htmlentities($result->UpdateAt) ?></td>
              <td>
                <span class="fw-medium dep-head-of-department badge <?php echo ($result->Status == 1) ? 'bg-label-success' : ''; ?>"><?php echo ($result->Status == 1) ? 'ACTIVE' : 'INACTIVE'; ?></span>
              </td>
              <td class="text-end">
                <div class="d-inline-block d-flex align-items-center justify-content-end text-nowrap">
                  ...
                  <button class="btn btn-sm btn-icon" onclick="openDeleteModal(<?php echo $result->id; ?>)">
