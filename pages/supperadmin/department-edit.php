        ...
        ?>
                <form id="formAuthentication" class="mb-3" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="edepname" name="edepname"
                            value="<?php echo $departmentname ?>" autofocus required />
                    </div>
                    <div class="col-md-12 mb-4">
                        <label for="headofunit" class="form-label">ប្រធានអង្គភាព</label>
                        <span class="text-danger fw-bold">*</span>
                        <div class="position-relative">
                            <select id="headofunit" name="eheadofunit"
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <span class="text-danger fw-bold">*</span>
                        <div class="position-relative">
                            <select id="depheadofunit" name="edepheadofunit[]" class="select2 form-select"
                                data-allow-clear="true" data-select2-id="depheadofunit" tabindex="-1" aria-hidden="true"
                                multiple>
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <span class="text-danger fw-bold">*</span>
                        <div class="position-relative">
                            <select id="select2Basic" name="eheaddep"
                                class="select2 form-select form-select-lg select2-hidden-accessible"
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <span class="text-danger fw-bold">*</span>
                        <div class="position-relative">
                            <select id="select2Basic1" name="edeheaddep" class="select2 form-select"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="updateat" class="form-control" value="<?php echo $createdate ?>"
                            disabled />
                    </div>
                    <?php if ($updateat == '') { ?>
                    <?php } else { ?>
