    ...
    FormValidation.formValidation(formAuthentication, {
      fields: {
        ...
        document: {
          validators: {
            notEmpty: {
              message: 'សូមជ្រើសរើសឯកសារភ្ជាប់'
            },
            file: {
              extension: 'doc,docx,xls,xlsx,pdf',
              type: 'application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/pdf',
              message: 'Please upload a valid file (doc, docx, xls, xlsx, pdf)'
            }
          }
        },
        usercontact: {
        ...
        formValidationPass: {
          validators: { notEmpty: { message: 'សូមជ្រើសរើសវាយបញ្ចូលមូលហេតុនៃការស្នើរសុំច្បាប់ឈប់សម្រាក' } }
        },
